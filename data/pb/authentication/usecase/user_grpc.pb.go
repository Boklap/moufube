...
func (c *userClient) Register(ctx context.Context, in *request.RegisterRequest, opts ...grpc.CallOption) (*response.RegisterResponse, error) {
...
func (UnimplementedUserServer) Register(context.Context, *request.RegisterRequest) (*response.RegisterResponse, error) {
...
func _User_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Register(ctx, req.(*request.RegisterRequest))
	}
